...
from unfold.widgets import (
    UnfoldAdminTextInputWidget, UnfoldAdminSelectWidget, 
    UnfoldAdminSelectWidget, UnfoldAdminDateWidget,
...
class ChooseMedClientWorkerForm(forms.ModelForm):
